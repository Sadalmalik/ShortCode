...
namespace GearBoxTools
{
    ...
    {
        public static Vector3 GetRectVector(this RectTransform rect, RectTransformComponent rectComponent)
        {
            switch (rectComponent)
            {
                case RectTransformComponent.AnchoredPosition:
                    return rect.anchoredPosition;
                case RectTransformComponent.AnchoredPosition3D:
        ...
        public static void SetRectVector(this RectTransform rect, RectTransformComponent rectComponent, Vector3 vector)
        {
            switch (rectComponent)
            {
                case RectTransformComponent.AnchoredPosition:
                ...
                case RectTransformComponent.AnchoredPosition3D:
                    rect.anchoredPosition3D = vector; return;
                case RectTransformComponent.AnchorMin:
